        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Tanim = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AciliyetId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hastalar_Aciliyetler_AciliyetId",
                        column: x => x.AciliyetId,
                        principalTable: "Aciliyetler",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Hastalar_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Tanim = table.Column<string>(type: "nvarchar(70)", maxLength: 70, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Raporlar_Hastalar_HastaId",
                        column: x => x.HastaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Hastalar_AciliyetId",
                table: "Hastalar",
                column: "AciliyetId");

            migrationBuilder.CreateIndex(
                name: "IX_Hastalar_AppUserId",
                table: "Hastalar",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Raporlar_HastaId",
                table: "Raporlar",
                column: "HastaId");
        }
